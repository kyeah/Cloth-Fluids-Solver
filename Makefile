...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Nov 27 16:49:38 2014
# Project:  fluids.pro
# Template: app
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib64 -lGLU -L/home/kyeh/cs/git/phys-sim-anim/fluid-solver/SOIL/lib -lSOIL -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/fluids1.0.0/ && $(COPY_FILE) --parents mainwindow.h glpanel.h controller.h simulation.h simparameters.h mesh.h rigidbodytemplate.h rigidbodyinstance.h vectormath.h camera.h rotator.h signeddistancefield.h collisions/Distance.h collisions/CTCD.h cloth.h mat3d.h .tmp/fluids1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp glpanel.cpp controller.cpp simulation.cpp simparameters.cpp mesh.cpp rigidbodytemplate.cpp rigidbodyinstance.cpp vectormath.cpp camera.cpp rotator.cpp signeddistancefield.cpp collisions/CTCD.cpp cloth.cpp .tmp/fluids1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/fluids1.0.0/ && (cd `dirname .tmp/fluids1.0.0` && $(TAR) fluids1.0.0.tar fluids1.0.0 && $(COMPRESS) fluids1.0.0.tar) && $(MOVE) `dirname .tmp/fluids1.0.0`/fluids1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/fluids1.0.0
...
libSOIL:
	cd /home/kyeh/cs/git/phys-sim-anim/fluid-solver/SOIL/projects/makefile/ && make
