...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Nov 28 16:58:29 2014
# Project:  catwalk.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile catwalk.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib -lGLU -L/home/kyeh/cs/git/phys-sim-anim/catwalk/SOIL/lib -lSOIL -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
libSOIL:
	cd /home/kyeh/cs/git/phys-sim-anim/catwalk/SOIL/projects/makefile/ && make
