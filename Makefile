...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Nov 11 17:52:43 2014
# Project:  catwalk.pro
# Template: app
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib -lGLU -L/v/filer4b/v41q001/evouga/course_projects/catwalk/SOIL/lib -lSOIL -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
libSOIL:
	cd /v/filer4b/v41q001/evouga/course_projects/catwalk/SOIL/projects/makefile/ && make
